...
class BookingRepository extends BaseRepository
{
    ...
    {
        //use findorfail method is better. Don't need to check if $cuser.
...
//            $jobs['total'] = $totaljobs;
    ...
    public function store($user, $data)
    {
        ...
        if ($user->user_type == env('CUSTOMER_ROLE_ID')) {
            $cuser = $user;
            Validator::extend('mustNotBeEmpty', function($attr, $value, $params){
            ...
            $validator->sometimes(['due_date', 'due_time','duration'], 'mustNotBeEmpty', function($input) {
                return $data['immediate'] == 'no';
            });
            $validator->sometimes(['customer_phone_type','customer_physical_type'], 'required', function($input) {
                return $data['immediate'] == 'no';
            });
...
//        $jobs = TeHelper::convertJobIdsInObjs($job_ids);
    ...
    {  
        //$job = Job::find($id);
        //I prefer use findorfail method.
